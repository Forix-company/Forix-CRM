...
@section('page-inner')
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
        <div>
            <h2 class="text-white pb-2 fw-bold">Bienvenido a Forix</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 form-group">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <h3 class="card-text">ETIQUETAS</h3>
                            ...
                            <div class="col-sm-3 form-group">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <h3 class="card-text">FABRICANTES</h3>
                            ...
                            <div class="col-sm-3 form-group">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <h3 class="card-text">INVENTARIO</h3>
                            ...
                            <div class="col-sm-3 form-group">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <h3 class="card-text">DEVOLUCION INVENTARIO</h3>
                            ...
                            <div class="col-sm-3 form-group">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <h3 class="card-text">INFORMES</h3>
                            ...
                            <div class="col-sm-3 form-group">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <h3 class="card-text">CONTABILIDAD</h3>
                            ...
                            <div class="col-sm-12 form-group">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            <i class="fas fa-store fa-6x" style="color:#007bff"></i>
                                        </h5>
                                        <h3 class="card-text">INGRESAR AL SISTEMA POS</h3>
