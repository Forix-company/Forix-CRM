                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            El Administrador Activo la Autenticacion de doble factor</p>
                                        ...
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Para iniciar en la plataforma por favor descargue una aplicacion OTP. para
                                            dispositivos moviles Android-IOS luego Por favor escanee el codigo QR con la
                                            aplicacion OTP</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            <a
                                                href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=es_CO&gl=US">Google
                                                Authenticator para android</a>
                                        </p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            <a href="https://apps.apple.com/es/app/google-authenticator/id388497605">Google
                                                Authenticator para Iphone's</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
